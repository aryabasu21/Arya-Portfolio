# Arya Basu— 3D Portfolio Website

This repository contains the source code for the personal 3D portfolio of **Arya Basu**, an Front-End Developer & Automation Engineer. Built with React, TypeScript, Three.js, React Three Fiber, and GSAP.

Live site: [https://a](https://m--zeta.vercel.app/)rya.stylnode.in

![Portfolio Preview](<public/images/Screenshot 2026-09-24 025541.png>)
...
**Search Tags:**
Arya Basu, Automation Developer, Front-End Developer, Python Developer, React Expert, RestAPI, Playwright, MongoDB, 3D Portfolio, React Three Fiber, Three.js, GSAP Animations, Modern Web Portfolio, Stylnode.
